...
class PredictionService:
    ...
    async def predict(self, classifier: EmotionClassifier, feature_extractor: FeatureExtractor,
                     start_id: int = 2701, end_id: int = 3000):
        ...
        test_features = await feature_extractor.transform(test_images, context="test images")
    ...
    async def save_submission(self, predictions, test_ids, output_file="submission.csv"):
