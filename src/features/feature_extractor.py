...
class FeatureExtractor:
    def __init__(self, feature_types=['hog', 'lbp', 'raw']):
    ...
    def _extract_raw(self, image):
        return image.flatten()
    
    async def extract_features(self, image):
    ...
    async def fit_transform(self, images):
    ...
    async def transform(self, images, context="images"):
